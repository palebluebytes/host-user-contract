...
(no `mode`, exercising the backward-compat read); `reference-contract-package-gui` is **v3**
(`mode = "gui"`, exercising the mode coupling guard). `conformance/contract-package.nix` asserts
