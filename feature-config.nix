...
# for a granted feature (ADR-0015 mechanic 5, ADR-0016). Host-affecting parameters
...
{ lib }:
{
  ...
  # UNION-aggregated (ADR-0016): on a single-seat host the display surface is the
