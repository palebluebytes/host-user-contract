...
# The CANONICAL, mandatory mechanism (ADR-0017 condition 1). It reads only data (`jq`) and
...
pkgs.writeShellApplication {
  ...
  text = ''
    ...
    # Tier 1 (semi-trusted): the repo must be SIGNED by a HOST-pinned key (ADR-0018, ADR-0019).
